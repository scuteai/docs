...
You can also set the metafield to up to show up on registration screen using the checkbox "Registration". You can also choose whether the metafield should be editable from the Profile component of Scute UI by enablingg the "Profile" checkbox.
